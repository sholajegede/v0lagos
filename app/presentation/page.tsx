...
export default function PresentationPage() {
  ...
  const SponsorCard = ({
      ...
      if (assetType === "svg") {
        return (
          <img
            ...
            alt={name}
            className="w-auto max-w-[184px] transition-opacity duration-300 group-hover:opacity-80 dark:brightness-100 brightness-0"
    ...
    const content = (
      <div
        className="relative w-full sm:w-[calc(50%-0.5px)] lg:w-[342px] h-[140px] lg:h-[173px] border border-border bg-background p-6 lg:p-8 flex flex-col items-center justify-center -mr-px -mb-px group cursor-pointer transition-all duration-700 hover:bg-accent hover:border-accent-foreground/20"
        style={{
          transitionDelay: `${delay}ms`,
          opacity: isVisible ? 1 : 0,
        }}
      >
        <ExternalLink className="absolute top-4 right-4 w-4 h-4 text-foreground opacity-0 translate-x-2 -translate-y-2 transition-all duration-300 group-hover:opacity-60 group-hover:translate-x-0 group-hover:translate-y-0" />
        {renderAsset()}
      </div>
    );
              ...
              <div
                ...
                className={`h-1 transition-all duration-300 ${
                  i <= currentSlide
                    ...
                    : "bg-gray-300 dark:bg-gray-300 dark:bg-gray-700 w-2"
                }`}
              />
            ))}
        </div>
      ...
      <div className="relative w-full h-screen flex flex-col items-center justify-center px-8 overflow-hidden">
        ...
        {currentSlide === 0 && (
          <div className="text-center">
            ...
            <p className="text-lg text-black dark:text-white dark:text-black dark:text-white mb-20 font-light tracking-tight">
              Build Your MVP in One Afternoon - From Idea to Live App Using AI -
              No Coding Required
            </p>
          </div>
        )}
        ...
        {currentSlide === 1 && (
          <div className="w-full max-w-3xl">
            <span className="text-xs font-mono text-gray-500 tracking-widest letter-spacing-wide">
              01 / WELCOME
            </span>
            <h2 className="text-6xl font-light mb-6 mt-6 tracking-tight">
              Welcome to <span className="slashed-zero">v0</span> IRL Lagos
            </h2>
            <p className="text-black dark:text-white mb-8 leading-relaxed font-light">
              This is a hands-on workshop where we'll build a complete full
              stack application together and you'll learn how to adapt it to
              YOUR idea.
            </p>
            ...
            <div className="mb-12">
              <h3 className="text-xl font-semibold mb-2 tracking-tight">
                Hosted by Shola Jegede
              </h3>
              <ul className="space-y-2 text-sm text-black dark:text-white font-light">
                <li>
                  <span className="mr-1">•</span>Official <span className="slashed-zero">v0</span> IRL Founding
                  Host (Vercel Global Program)
                </li>
                <li>
                  <span className="mr-1">•</span>Founder, NextMVP.tech - Built 8+ MVPs for founders in 2025
                </li>
                <li>
                  <span className="mr-1">•</span>Co-founder, TaxCal.ng - Built with{" "}
                  <span className="slashed-zero">v0</span> in 2 hours (7,000+
                  tax calculations in 7 days)
                </li>
                <li>
                  <span className="mr-1">•</span>Head of Product & Partnerships, BuildersCabal (800+ builders)
                </li>
                <li>
                  <span className="mr-1">•</span>Engineering Judge, 2024 Global Entrepreneurship Festival
                </li>
              </ul>
            </div>
            ...
            {/* Supporters Section */}
            <div>
              <p className="text-xs font-mono text-gray-500 tracking-widest mb-8">
                SUPPORTED BY
              </p>
        ...
        {currentSlide === 2 && (
          <div className="w-full max-w-3xl">
            ...
            <h2 className="text-6xl font-light mb-8 mt-6 tracking-tight">
              The Agenda
            </h2>
              ...
              {[
                {
                  ...
                  desc: "A special video message from the v0 team sharing insights and inspiration for the event.",
                },
                {
                  title: "The Challenge",
                  desc: "Understanding the flow, defining what success looks like, and preparing for the build ahead.",
                },
                {
                  title: "Pick a Track",
                  desc: "Choose an inspiration track to build from based on your goals.",
                },
                {
                  title: "Build Session",
                  desc: "45 minutes of focused building where you transform ideas into deployed applications.",
                },
                {
                  title: "Ship & Showcase",
                  desc: "Deploy to production, submit your work, and watch demos from fellow builders.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="border border-gray-300 dark:border-gray-800 rounded-lg p-4 flex gap-4 hover:border-gray-400 dark:hover:border-gray-600 transition-colors"
                >
                  <span className="font-semibold text-black dark:text-white w-6 flex-shrink-0">
        ...
        {currentSlide === 3 && (
          <div className="w-full h-screen flex flex-col items-center justify-center px-8">
            <div className="w-full max-w-4xl">
              <span className="text-xs font-mono text-gray-500 tracking-widest mb-8 block">
                03 / VERCEL TEAM WELCOME
              </span>
              ...
              <p className="text-center text-black dark:text-white text-sm mt-6">
                Press ESC or click X to continue
              </p>
            </div>
          </div>
        )}
        ...
        {currentSlide === 4 && (
          <div className="w-full max-w-3xl">
            ...
            <h2 className="text-6xl font-light mb-6 mt-6 tracking-tight">
              From Someday to Shipped
            </h2>
            <p className="text-black dark:text-white mb-8 leading-relaxed font-light">
              45 minutes. One idea. A working app at a live URL. Ship, showcase,
              and win.
            </p>
        ...
        {currentSlide === 5 && (
          <div className="w-full max-w-4xl">
            <span className="text-xs font-mono text-gray-500 tracking-widest">
              05 / CHOOSE YOUR TRACK
            </span>
            <h2 className="text-6xl font-light mb-4 mt-6 tracking-tight">
              Pick a Track
            </h2>
            <p className="text-black dark:text-white mb-8 font-light">
              Choose an inspiration track to build from based on your goals.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4">
              {presentationTracks.map((track) => (
                ...
                >
                  ...
                  <p className="text-xs text-black dark:text-white mb-4 font-light">
                    {track.description}
                  </p>
                  ...
                  {expandedTrack === track.id && (
                    <div className="space-y-2">
                      {track.ideas.map((idea, idx) => (
                        <p
                          key={idx}
                          className="text-xs text-gray-700 dark:text-gray-400 font-light"
                        >
                          • {idea}
                        </p>
                      ))}
        ...
        {currentSlide === 6 && (
          <div className="w-full max-w-3xl">
            ...
            <div className="border border-gray-300 dark:border-gray-700 rounded-lg p-8 mb-5 hover:border-gray-400 dark:hover:border-gray-600 transition-colors">
              ...
              <p className="text-4xl font-mono font-light tracking-widest mb-8 bg-gray-200 dark:bg-white/10 text-black dark:text-white px-6 py-4 rounded-lg inline-block">
                V0PROMPTTOPRODUCTION2026
              </p>
              ...
              <ol className="space-y-3 text-sm">
                <li>
                  ...
                  >
                    <span className="slashed-zero">v0</span>.app
                  </Link>
                </li>
                <li>
                  <span className="font-bold">2.</span> Navigate to{" "}
                  <span className="font-mono">
                    Settings → Billing → Redeem Usage Code
                  </span>
                </li>
                <li>
                  <span className="font-bold">3.</span> Enter the code above
                </li>
                <li>
                  <span>
                    OR click on this link:{" "}
                    <Link
                      href="https://v0.app/chat/settings/billing"
                      target="_blank"
                      className="font-mono text-blue-400"
                    >
                      https://v0.app/chat/settings/billing
                    </Link>
                  </span>
                </li>
              </ol>
        ...
        {currentSlide === 7 && (
          <div className="w-full max-w-2xl text-center">
            ...
            <p className="text-black dark:text-white mb-16 font-light">
              45 minutes of focused building where you transform ideas into
              deployed applications.
            </p>

            <div className="mb-16">
              <p className="text-8xl font-mono font-light mb-2 tracking-tight">
            ...
            <div className="grid grid-cols-3 gap-6">
              {[
                {
                  title: "Prompt",
                  desc: "Start with a natural language description of what you want to build",
                },
                {
                  title: "Iterate",
                  desc: "Refine and expand your application with conversational edits",
                },
                {
                  title: "Deploy",
                  desc: "Ship to production with one click on Vercel's infrastructure",
                },
              ].map((step, i) => (
                <div
                  key={i}
                  className="border border-gray-300 dark:border-gray-700 rounded-lg p-6 hover:border-gray-400 dark:hover:border-gray-600 transition-colors"
                >
                  <h3 className="font-semibold mb-2 tracking-tight">
                    {step.title}
                  </h3>
        ...
        {currentSlide === 8 && (
          <div className="text-center">
            ...
            <p className="text-black dark:text-white mb-12 max-w-2xl mx-auto font-light">
              Deploy to production, submit your work, and watch demos
              ...
              {[
                {
                  num: "01",
                  title: "Deploy",
                  desc: "Push your creation live to the world",
                },
                {
                  num: "02",
                  title: "Submit",
                  desc: "Share your deployed URL for the showcase",
                },
                {
                  num: "03",
                  title: "Demo & Vote",
                  desc: "Watch demos from fellow builders and vote on builds",
                },
              ].map((step, i) => (
                <div
                  key={i}
                  className="border border-gray-300 dark:border-gray-700 rounded-lg p-6 hover:border-gray-400 dark:hover:border-gray-600 transition-colors"
                >
                  <p className="text-2xl font-light mb-3 tracking-tight slashed-zero">
                    {step.num}
                  </p>
                  <h3 className="font-semibold mb-2 tracking-tight">
                    {step.title}
            ...
            <div className="flex items-center justify-center">
              <img
                src={logos.v0 || "/placeholder.svg"}
                alt="v0"
                className="h-6 w-12 transition-opacity duration-300 group-hover:opacity-80 dark:invert-0 invert"
              />
            </div>
          </div>
        )}
